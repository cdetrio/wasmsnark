...
async function runBench() {
  try {
    ...
    */
    ...
    const pVW = bls12.alloc(n8*2);
    bls12.setF1(pVW, "1368588654857894878418275568728522126509225138946700730641519125678837625943210272426023428152507345261242478977209");
    bls12.setF1(pVW + n8, "595162695551560935096575469966673100066956936968872996017557172004618803176589747013153322457437226437701984958338");
    bls12.instance.exports.f2m_toMontgomery(pVW, pVW);
